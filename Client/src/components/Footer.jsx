...
const Footer = () => {
  return (
      <div className='text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32 border-t'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
                ...
                <div>
                    <p className='text-md text-black'>QUICK LINK</p>
                    <ul className='mt-3 flex flex-col gap-2 text-sm text-gray-500 '>
                        <li><a href="#">Home</a></li>
                        <li><a href="#">List Ypur Car</a></li>
                        <li><a href="#">About us</a></li>
                    </ul>
                </div>

                <div>
                    <p className='text-md text-black'>SUPPORT</p>
                    <ul className='mt-3 flex flex-col gap-2 text-sm text-gray-500'>
                ...
                <div className='max-w-80'>
                    <p className='text-md text-black'>CONTACT</p>
